...
function retirerRdvUti(id_reservation, id_utilisateur) {
    document.location.href = "../../controlleur/controlleurTableaudebordUti.php?retirerRendezvousModal=" + id_reservation + "&id_utilisateur=" + id_utilisateur;
}
...
$('#btnSubmitRetirerRdvUti').click(function (e) {
    e.preventDefault();
    var $this = $(this);
    retirerRdvUti($this.data("idReservation"), $this.data("idUtilisateur"));
});
