...
if(isset($_GET["retirezRendezvousModal"]) || (isset($_POST["action"]) && $_POST["action"] == "retirezRendezvousModal")) {
	if(isset($_POST["action"]) && $_POST["action"] == "retirezRendezvousModal") {
		$id_utilisateur = $_POST["id_utilisateur_reservation"];
    	$id_reservation = $_POST["retirezRendezvousModal"];
	} else {
...
if(isset($_POST["action"]) && $_POST["action"] == "parametrages") {
	$option_rdv = $_POST["option_rdv"];
	...
	$result = parametrages($pdo, ($option_rdv == "on" ? 1 : 0), ($option_email_1 == "on" ? 1 : 0), ($option_email_2 == "on" ? 1 : 0), ($option_evenement == "on" ? 1 : 0), $titre_evenement, $paragraphe_evenement);
