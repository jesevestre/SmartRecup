...
<head>
    ...
    <title>Le rendez-vous avec Maxime</title>
...
<body>
    ...
    <div class="container-first">
            <h1><span class="titre">Le rendez-vous </span><span class="titre">avec Maxime</span><span class="titreHidden"> </span></h1>

        <div class="container-btns">
            <a href="vue/decouvrir.php"><button type="button" class="btn-first btn-decouvrir b1">Découvrir</button></a>
            <a href="vue/inscription.php"><button class="btn-first b2">Inscription</button></a>
            <a href="vue/connexion.php"><button class="btn-first b3">Connexion</button></a>
        </div>
    </div>
    ...
    <div>
        ...
        <a href="indexEN.php"><img src="contenu/images/drapeauUSA2.png" class="logo" alt="Lien vers la page d'accueil en Anglais" /></a>
    </div>
    ...
    ?>
        <div class="banniere">
            <div class="text-banniere">
                <p> Ce site utilise quelques cookies navigateur <span class="invisible-banniere-text">pour vous proposer la meilleure expérience possible</span>&nbsp;&nbsp;</p>
            </div>
