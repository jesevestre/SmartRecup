                                        ...
                                        <div class="modal-footer col-10 mt-3">
                                            ...
                                            <div class="col-4">
                                                <?php if($dateColor > $date_demain) { ?>
                                                    <a class="btn btn-secondary mx-auto w-100 btnRetirerRdvUti" data-ids="<?= $reservationUti->reservation_id . " " . $reservationUti->utilisateur_id ?>" data-bs-toggle="modal" data-bs-target="#btnRetirerRdvUti" href="#" data-bs-backdrop="static"><i class="fa fa-times"></i>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                        </div>
