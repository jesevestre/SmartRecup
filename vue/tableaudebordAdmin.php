    ...
    <div class="row justify-content-around d-flex justify-content-center">
        ...
        if(isset($_GET["error"]) || isset($_GET["success"]) || isset($_GET["bouton"])) {
            ...
            if($error == "error") {
                ...
                $icone = "fas fa-arrow-right";
                $color = "alert-success";
            } else if($success == "success8") {
                $message = "<b>Les nouveaux paramétrages ont été mis à jour.</b>";
                $icone = "fas fa-arrow-right";
                $color = "alert-success";
        ...
        <div id="gestion" class="col-12 mt-3">
            ...
            <div class="row mt-1">
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-2 mb-2 d-grid mx-auto">
                    <a class="col-12 btn btn-danger mx-auto" data-bs-toggle="modal" data-bs-target="#parametrages" data-bs-backdrop="static"><i class="fa-solid fa-gear"></i>&nbsp;Paramétrage</a>
                </div>
            </div>
            <?php
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="retirezRendezvousModal" id="reservationsClient" required disabled>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-6">
                        <input type="hidden" name="action" value="retirezRendezvousModal">
...
<div class="modal fade" id="parametrages" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="POST" action="../controlleur/controlleurTableaudebordAdmin.php">
            <div class="modal-content">
                <div class="modal-header danger text-white">
                    <h5 class="modal-title"><i class="fa-solid fa-gear"></i> Paramétrage</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="alert alert-warning small">
                        <i class="fas fa-lightbulb"></i> Bon à savoir, à partir d'ici, vous pourrez <b>paramétrer l'application</b> comme vous le souhaitez.
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-6">
                        <input type="hidden" name="action" value="parametrages">
                        <button type="submit" class="btn btn-secondary btn-sm" style="width: 90%;" id="parametrages">Enregistrer <i class="fa fa-save"></i></button>
                    </div>
                </div>
            </div>
        </form>
