...
<div class="row d-flex justify-content-center mt-5 pb-5">
    ...
    <div class="row cadrage">
        ...
        <div class="col-sm-6 pt-4">
            ...
            <div>
                <p class="justifie">En cas de doutes, <b>n'hésitez pas à nous contacter</b> par le formulaire de contact accessible en cliquant <a href="/vue/contact.php">ici</a>.</p>
            </div>
        </div>
